...
///- &quot;popup&quot; - Reminders are sent via a UI popup.</summary>
    ...
    public class Subscription {
        ...
        private Subscription.ChannelParamsData _channelParams;
        ...
        /// <summary>An opaque topic id that identifies the backend resource which has been subscribed to. Stable across different API versions</summary>
        ...
        /// <summary>A subscription to an API resource</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("kind")]
        public virtual string Kind {
            get {
                return this._kind;
        ...
        /// <summary>The canonicalized URI of the subscribed-to resource.</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("topicUri")]
        public virtual string TopicUri {
            get {
                return this._topicUri;
            }
            set {
                this._topicUri = value;
            }
        }
        
        /// <summary>The address of the receiving entity where notifications are delivered. Specific to the channel mechanism.</summary>
        ...
        /// <summary>The expiration instant for this subscription if it is defined.</summary>
        ...
        [Newtonsoft.Json.JsonPropertyAttribute("channelParams")]
        public virtual Subscription.ChannelParamsData ChannelParams {
            get {
        ...
        /// <summary>An arbitrary string associated with the subscription that is delivered to the target address with each notification for this subscription.</summary>
        ...
        /// <summary>A UUID for the subscription</summary>
        [Newtonsoft.Json.JsonPropertyAttribute("id")]
        public virtual string Id {
            get {
                return this._id;
        ...
        /// <summary>The delivery channel mechanism to use for notifications</summary>
        ...
        /// <summary>Additional parameters controlling delivery channel behavior</summary>
        public class ChannelParamsData : System.Collections.Generic.Dictionary<string, string> {
        }
    }
...
///- &quot;transparent&quot; - The event does not block time on the calendar.</summary>
        ...
        /// <summary>Whether this is a private event copy where changes are not shared with other copies on other calendars. Optional. Immutable. The default is False.</summary>
...
namespace Google.Apis.Calendar.v3 {
    ...
    public class SubscriptionsResource {
        ...
        public SubscriptionsResource(CalendarService service, Google.Apis.Authentication.IAuthenticator authenticator) {
            this.service = service;
            this.authenticator = authenticator;
        }
        
        public virtual UnsubscribeRequest Unsubscribe(Google.Apis.Calendar.v3.Data.Subscription body) {
            return new UnsubscribeRequest(service, body);
        }
        
        public class UnsubscribeRequest : Google.Apis.Requests.ClientServiceRequest<string> {
            ...
            private Google.Apis.Calendar.v3.Data.Subscription _Body;
            
            public UnsubscribeRequest(Google.Apis.Services.IClientService service, Google.Apis.Calendar.v3.Data.Subscription body) : 
                    base(service) {
                this.Body = body;
                this.InitParameters();
            }
            ...
            /// <summary>Gets/Sets the Body of this Request.</summary>
            public virtual Google.Apis.Calendar.v3.Data.Subscription Body {
                get {
                    return this._Body;
                }
                set {

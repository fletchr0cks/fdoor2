...
namespace LinqToTwitterMvcDemo.Models
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="db61a6afb29dc84f4597e3a2b500ebed20")]
    ...
    partial void Deleteuser(user instance);
		...
		public System.Data.Linq.Table<days2go> days2gos
		{
			get
			{
    ...
    partial void OntypeChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_bannerid", DbType="VarChar(50) NOT NULL", CanBeNull=false)]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="user_banner", Storage="_user", ThisKey="userid", OtherKey="id", IsForeignKey=true)]
		public user user
		{
			get
			{
    ...
    partial void Onarticle1Changing(string value);
    partial void Onarticle1Changed();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="article", Storage="_article1", DbType="VarChar(MAX)")]
		public string article1
		{
			...
			set
			{
				if ((this._article1 != value))
				{
					this.Onarticle1Changing(value);
					this.SendPropertyChanging();
					this._article1 = value;
					this.SendPropertyChanged("article1");
					this.Onarticle1Changed();
				}
			}
		}
    ...
    partial void OneventURLChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="user_days2go", Storage="_user", ThisKey="userid", OtherKey="id", IsForeignKey=true)]
		public user user
		{
			get
			{
			...
			set
			{
							...
							|| (this._user.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._user.Entity = null;
						previousValue.days2gos.Remove(this);
					}
					this._user.Entity = value;
					if ((value != null))
					{
						value.days2gos.Add(this);
						this._userid = value.id;
					}
					else
					{
    ...
    partial void OnstatusChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="user_days2go", Storage="_days2gos", ThisKey="id", OtherKey="userid")]
		public EntitySet<days2go> days2gos
		{
			get
			{
				return this._days2gos;
			}
			set
			{
				this._days2gos.Assign(value);
			}
		}
		...
		private void attach_days2gos(days2go entity)
		{
			this.SendPropertyChanging();
			entity.user = this;
		}
